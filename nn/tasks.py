...
SEGMENT_CLASS = (Segment, Segment_Efficient,)
POSE_CLASS = (Pose,)
OBB_CLASS = (OBB,)
C3K2_CLASS = (C3k2_MutilScaleEdgeInformationSelect,)
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
                         Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, C2fPSA,
                         C2PSA, DWConv, Focus, BottleneckCSP,
                         C1, C2, C2f, C3k2, ELAN1, AConv, SPPELAN, C2fAttn, C3, C3TR, C3Ghost,
                         nn.ConvTranspose2d, DWConvTranspose2d,
                         C3x, RepC3, PSA, SCDown, C2fCIB, KWConv, nn.Conv2d,
                         SimpleStem, VisionClueMerge,
                         VSSBlock_YOLO, XSSBlock,
                         RFAConv, RFCBAMConv, RFCAConv, C2BRA, C2CGA,C2DA, C2DPB,
                         C2Pola, A2C2f, C2TSSA, RepHMS,
                         C2ASSA, C2PSA_DYT, C2TSSA_DYT, C2Pola_DYT
                 ) + C3K2_CLASS):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in ((
                ...
                XSSBlock, C2BRA, C2CGA, C2DA, C2DPB,
                C2Pola, A2C2f, C2TSSA,  C2ASSA, C2PSA_DYT,
                C2TSSA_DYT, C2Pola_DYT
            ) + C3K2_CLASS):
            ...
            c2 = m.channel
                   ...
                   DySample, CAA, ELA, AFGCAttention, EfficientChannelAttention,  AttentiveLayer}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
